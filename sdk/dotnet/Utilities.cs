...
namespace Davidmontoyago.GcpVertexModelDeployment
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/davidmontoyago/pulumi-gcp-vertex-model-deployment";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Davidmontoyago.GcpVertexModelDeployment.version.txt");
    ...
    internal sealed class GcpVertexModelDeploymentResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GcpVertexModelDeploymentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
