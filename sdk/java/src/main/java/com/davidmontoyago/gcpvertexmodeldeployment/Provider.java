...
package com.davidmontoyago.gcpvertexmodeldeployment;

import com.davidmontoyago.gcpvertexmodeldeployment.ProviderArgs;
...
@ResourceType(type="pulumi:providers:gcp-vertex-model-deployment")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp-vertex-model-deployment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
